...
with_mask_path = r'C:\Users\megha\OneDrive\Desktop\mini project\datasets final\with_mask'
with_mask_data, with_mask_labels = load_and_preprocess_data(with_mask_path, label=1)

# Load data for images without masks
without_mask_path = r'C:\Users\megha\OneDrive\Desktop\mini project\datasets final\without_mask'
without_mask_data, without_mask_labels = load_and_preprocess_data(without_mask_path, label=0)
